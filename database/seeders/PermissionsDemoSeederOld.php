...
class PermissionsDemoSeeder extends Seeder
{
     ...
     public function run()
    {
        ...
        Permission::create(['guard_name' => 'api','name' => 'register_cabbin']);
        Permission::create(['guard_name' => 'api','name' => 'list_cabbin']);
        Permission::create(['guard_name' => 'api','name' => 'edit_cabbin']);
        Permission::create(['guard_name' => 'api','name' => 'delete_cabbin']);
        Permission::create(['guard_name' => 'api','name' => 'profile_cabbin']);
